...
hparams = {
    ...
    'args': [{
        'env': ['Catch-bsuite', 'DeepSea-bsuite', 'MemoryChain-bsuite', 'UmbrellaChain-bsuite', 'DiscountingChain-bsuite', 'MNISTBandit-bsuite'],
        'memoryless': True,
        'lr': ' '.join(map(str, lrs)),
        ...
        'max_grad_norm': 0.5,
        'hidden_size': 128,
        'depth': 5,  # Add a new hyperparameter 'depth' with value '5'
        'num_minibatches': 4,
        'num_envs': 4,
        'num_steps': 128,
        'steps_log_freq': 4,
