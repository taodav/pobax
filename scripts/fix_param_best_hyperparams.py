"""
This file finds the best hparams over all values of one hparam.
"""
import argparse
import pickle
...
if __name__ == "__main__":
    ...
    parser.add_argument('--fixed_param', type=str, default='ld_exploration_bonus_scale')
    ...
    for val in all_hyperparams[args.fixed_param]:
        # Create an index tuple that uses full slices for all dimensions initially
        indexer = [slice(None)] * scores.ndim
