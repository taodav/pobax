...
if __name__ == "__main__":
    ...
    study_paths = [
        ...
        # ('SF', Path(ROOT_DIR, 'results', 'sf_ppo', f'{env_name}_sf_ppo'), 'cyan'),
        ('SF discrep', Path(ROOT_DIR, 'results', 'sf_ppo', f'{env_name}_sf_ppo_discrep'), 'cyan'),
    ...
    # ylims = (0, 22)  # for rocksample_11_11 hsize
    # # ylims = None
    #
