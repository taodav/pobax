...
if __name__ == "__main__":
    ...
    study_paths = [
        ...
        ('PPO + RNN', Path(ROOT_DIR, 'results', f'{env_name}_ppo_madrona'), 'purple'),
        ('PPO + RNN + LD', Path(ROOT_DIR, 'results', f'{env_name}_ppo_LD_madrona'), 'blue'),
        ('PPO + MEMORYLESS', Path(ROOT_DIR, 'results', f'{env_name}_memoryless_ppo_madrona'), 'dark gray'),
        ('PPO + OBSERVABLE', Path(ROOT_DIR, 'results', f'{env_name}_memoryless_ppo_no_frame_madrona'), 'green'),
