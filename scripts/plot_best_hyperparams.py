...
if __name__ == "__main__":
    ...
    # normal
    study_paths = [
        ('RNN', Path(ROOT_DIR, 'results', f'{env_name}_ppo_best'), 'purple'),
        ('RNN + LD', Path(ROOT_DIR, 'results', f'{env_name}_ppo_LD_best'), 'blue'),
        ('Memoryless', Path(ROOT_DIR, 'results', f'{env_name}_ppo_memoryless_best'), 'dark gray'),
        ('STATE', Path(ROOT_DIR, 'results', f'{env_name}_ppo_perfect_memory_best'), 'green'),
        ('TRANFORMER', Path(ROOT_DIR, 'results', f'{env_name}_transformer_best'), 'cyan'),
    ]
