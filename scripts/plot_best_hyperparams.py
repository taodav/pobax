...
if __name__ == "__main__":
    ...
    study_paths = [
        ...
        ('RNN', Path(ROOT_DIR, 'results', 'qr_ppo', env_name, f'{env_name}_ppo_qr'), 'purple'),
        ('LD', Path(ROOT_DIR, 'results', 'qr_ppo', env_name, f'{env_name}_ppo_qr_discrep'), 'blue'),
        ('Ent', Path(ROOT_DIR, 'results', 'qr_ppo', env_name, f'{env_name}_ppo_qr_ent'), 'yellow'),
