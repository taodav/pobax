...
if __name__ == "__main__":
    ...
    study_paths = [
        ...
        # ('SF raw hs diff', Path(ROOT_DIR, 'results', 'gd_sf_hs', env_name, f'{env_name}_gd_sf_ppo_hs_diff'), 'cyan'),
        # ('SF raw hs diff discrep', Path(ROOT_DIR, 'results', 'gd_sf_hs', env_name, f'{env_name}_gd_sf_ppo_hs_diff_discrep'), 'yellow'),
